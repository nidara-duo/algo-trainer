define("vs/basic-languages/monaco.contribution", ["require", "../editor.api"], (function(require, editor_api) {
  "use strict";
  ...
  registerLanguage({
    ...
    loader: () => new Promise((resolve, reject) => require(["../python"], resolve, reject))
  });
  registerLanguage({
    id: "qsharp",
    extensions: [".qs"],
